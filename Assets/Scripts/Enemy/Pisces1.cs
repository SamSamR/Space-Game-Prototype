...
public class Pisces1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        goal5 = GameObject.Find("Cylinder (4)").transform.position;
        goal6 = GameObject.Find("Cylinder (5)").transform.position;
        goal7 = GameObject.Find("Cylinder (6)").transform.position;
        goal8 = GameObject.Find("Cylinder (7)").transform.position;
